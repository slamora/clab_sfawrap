...
class PGv2(RSpecVersion):
    ...
    ######################################################################################
    # MODIFICATIONS FOR C-LAB SFAWRAP
    # Add methods to manage services element, which contains the Login element
    # needed in the Rspec of the Provision operation
    
    # sudo  cp /home/gerard/git/sfa/sfa/sfa/clab/pgv2.py  /usr/lib/python2.7/dist-packages/sfa/rspecs/versions/
